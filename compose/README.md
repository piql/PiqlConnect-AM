...
clone:
    ...
    $ git clone https://github.com/piql/piql-archivematica-compose.git

Run the installation (and all Docker Compose) commands from within the compose
directory:

    $ cd ./piql-archivematica/compose
...
https://github.com/piql/piql-archivematica-compose/tree/master/src which are from the
...
[0]: https://github.com/piql/archivematica/tree/qa/1.x/src/MCPClient/osdeps
[1]: https://github.com/piql/archivematica/blob/qa/1.x/src/MCPClient.Dockerfile
[2]: https://github.com/piql/archivematica/pull/931
[3]: https://github.com/piql/archivematica/blob/qa/1.x/src/MCPClient-base.Dockerfile
...
- Make sure that you've checked out the
  [latest](https://github.com/piql/piql-archivematica-compose/commit/HEAD) commit of this
  repository.
...
[am0-issues]: https://github.com/piql/piql-archivematica-compose/tree/5984aee49a53d127ec8628747352395d1c6a247f/compose
[am1-issues]: https://github.com/piql/archivematica/issues
[am2-issues]: https://github.com/piql/piql-archivematica-compose/issues
[am3-issues]: https://github.com/piql/issues/issues
